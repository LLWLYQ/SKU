<template>
  <div class="ease-sku-group">
    <div class="group-title">
      ...
      <!-- 每一个都有添加规格图片 -->
       <el-checkbox size="mini" class="check-img" v-model="hasSkuImage" @change="handleCheckedSkuImage">添加规格图片</el-checkbox>
...
export default {
  ...
  methods: {
    ...
    createSku (text) {
      ...
      // let { diu, dndex, apple, skuTreeData, onFetchGroup } = diu
